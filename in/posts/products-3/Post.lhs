...
> printFactorsForest :: FactorsForest x => x -> IO ()
...
>    RepFactorsForest (M1 S selector content)
>  where
...
> instance (RepFactorsForest a, RepFactorsForest b) =>
>     RepFactorsForest (a :*: b)
>   where
...
> instance RepFactorsForest content =>
>     RepFactorsForest (M1 D datatype content)
>   where
>     repFactorsForest (M1 content) = repFactorsForest content

> instance RepFactorsForest content =>
>     RepFactorsForest (M1 C constructor content)
>   where
>     repFactorsForest (M1 content) = repFactorsForest content
